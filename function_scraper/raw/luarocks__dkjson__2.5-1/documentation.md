# dkjson – JSON Module for Lua [(dkolf.de)](http://dkolf.de/)
## Introduction
...
## Download
  ...
  * Preview: [dkjson.lua version 2.9-beta.2](http://dkolf.de/dkjson-lua/dkjson-2.9-beta.2.lua)
  * All versions along with their SHA-256 hash can be found on the [downloads page](http://dkolf.de/downloads). 
...
### [async-await in Lua](http://dkolf.de/lua-async-await)
...
### [Software dependencies](http://dkolf.de/dependencies)
...
### Preview: 2.9-beta.2 (2026-03-14)
  * Download [dkjson.lua version 2.9-beta.2](http://dkolf.de/dkjson-lua/dkjson-2.9-beta.2.lua)
  * Read the [documentation](http://dkolf.de/dkjson-lua/readme-2.9-beta.2.md)
...
### Version 2.8 (2024-06-17)
  * Download [dkjson.lua version 2.8](http://dkolf.de/dkjson-lua/dkjson-2.8.lua)
  * Read the [documentation](http://dkolf.de/dkjson-lua/readme-2.8.txt)
...
### Version 1.4 (2024-06-17)
  * Download [dkjson.lua version 1.4](http://dkolf.de/dkjson-lua/dkjson-1.4.lua)
...
### Version 2.7 (2024-02-20)
  * Download [dkjson.lua version 2.7](http://dkolf.de/dkjson-lua/dkjson-2.7.lua)
  * Read the [documentation](http://dkolf.de/dkjson-lua/readme-2.7.txt)
...
### Version 2.6 (2021-12-19)
  * Download [dkjson.lua version 2.6](http://dkolf.de/dkjson-lua/dkjson-2.6.lua)
  * Read the [documentation](http://dkolf.de/dkjson-lua/readme-2.6.txt)
...
### Version 2.5 (2014-04-28)
  * Download [dkjson.lua version 2.5](http://dkolf.de/dkjson-lua/dkjson-2.5.lua)
  * Read the [documentation](http://dkolf.de/dkjson-lua/readme-2.5.txt)
...
### Version 2.4 (2013-09-28)
  * Download [dkjson.lua version 2.4](http://dkolf.de/dkjson-lua/dkjson-2.4.lua)
...
### Version 1.3 (2013-09-28)
  * Download [dkjson.lua version 1.3](http://dkolf.de/dkjson-lua/dkjson-1.3.lua)
...
### Version 2.3 (2013-04-14)
  * Download [dkjson.lua version 2.3](http://dkolf.de/dkjson-lua/dkjson-2.3.lua)
...
### Version 1.2 (2013-04-14)
  * Download [dkjson.lua version 1.2](http://dkolf.de/dkjson-lua/dkjson-1.2.lua)
...
### Version 2.2 (2012-04-28)
  * Download [dkjson.lua version 2.2](http://dkolf.de/dkjson-lua/dkjson-2.2.lua)
...
### Version 2.1 (2011-07-08)
  * Download [dkjson.lua version 2.1](http://dkolf.de/dkjson-lua/dkjson-2.1.lua)
...
### Version 1.1 (2011-07-08)
  * Download [dkjson.lua version 1.1](http://dkolf.de/dkjson-lua/dkjson-1.1.lua)
...
### Version 2.0 (2011-05-30)
  * Download [dkjson.lua version 2.0](http://dkolf.de/dkjson-lua/dkjson-2.0.lua)
...
Initial version. 
  * Download [dkjson.lua version 1.0](http://dkolf.de/dkjson-lua/dkjson-1.0.lua)


[dkolf.de](http://dkolf.de/) · [contact](http://dkolf.de/contact) · [RSS](https://dkolf.de/rss)
